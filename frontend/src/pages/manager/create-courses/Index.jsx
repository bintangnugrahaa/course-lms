    ...
    <>
      ...
      >
        ...
        <div className="relative flex flex-col gap-[10px]">
          ...
          <div className="relative flex w-full h-[200px] rounded-[20px] border border-[#CFDBEF] overflow-hidden">
            <button
              type="button"
              onClick={() => inputFileRef.current.click()}
              className="absolute inset-0 flex justify-center items-center gap-3"
            >
              <img
          ...
          <input
            ...
            className="hidden"
          />
          <span className="text-[#FF435A]">{errors.thumbnail?.message}</span>
        </div>
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <span className="text-[#FF435A]">{errors.tagline?.message}</span>
        </div>
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <span className="text-[#FF435A]">{errors.categoryId?.message}</span>
        </div>
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <div className="flex w-full rounded-[20px] border border-[#CFDBEF] gap-3 p-5 focus-within:ring-2 focus-within:ring-[#662FFF]">
            <img
            ...
            <textarea
              ...
              id="desc"
              rows={5}
              className="appearance-none outline-none w-full font-semibold !bg-transparent"
              placeholder="Explain what this course about"
            />
          </div>
          <span className="text-[#FF435A]">{errors.description?.message}</span>
        </div>
