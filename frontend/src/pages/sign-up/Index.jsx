...
export default function SignUpPage() {
  ...
  const onSubmit = (data) => {
    setDataSignUp(data);
    toast.success("Data berhasil disimpan, silakan pilih paket");
    setMode("PRICING");
  };
        ...
        <div className="relative flex flex-col flex-1 p-[10px]">
          ...
          <div className="flex items-center justify-center gap-[109px] my-auto">
            <form
              ...
              className="flex flex-col w-[400px] rounded-[20px] border border-[#262A56] p-[30px] gap-[30px] bg-[#080A2A]"
            >
              <div>
                <h2 className="font-bold text-[26px] text-white">Sign Up</h2>
